  ...
  'zh-CN': {
    translation: {
      ...
      rules: {
        ...
        versions: {
          title: '规则版本',
          subtitle: '发布当前规则快照，支持按版本回滚',
          publish: '发布版本',
          publishing: '发布中...',
          rollback: '回滚到此版本',
          rollingBack: '回滚中...',
          rollbackConfirm: '确认回滚到规则版本 v{{version}} 吗？',
          na: '-',
          table: {
            version: '版本',
            ruleCount: '规则数',
  ...
  en: {
    translation: {
      ...
      rules: {
        ...
        versions: {
          title: 'Rule Versions',
          subtitle: 'Publish snapshots of current rules and roll back by version',
          publish: 'Publish Version',
          publishing: 'Publishing...',
          rollback: 'Rollback to This Version',
          rollingBack: 'Rolling back...',
          rollbackConfirm: 'Roll back to rule version v{{version}}?',
          na: '-',
          table: {
            version: 'Version',
